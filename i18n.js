define(["./_base/kernel", "require", "./has", "./_base/array", "./_base/config", "./_base/lang"/*, "./_base/xhr"*/],
	...
	var
		...
		doLoad = function(require, bundlePathAndName, bundlePath, bundleName, locale, load){
			...
			require([bundlePathAndName], function(root){ if(!root){root = {root: null}} 
				var
		...
		load = function(id, require, load, config){
			...
			var
				...
				targetLocale=  localeSpecified || (dojo.locale) ? dojo.locale : config.locale,
	...
	if(has("dojo-v1x-i18n-Api")){
		var
			...
			syncRequire= function(deps, callback){ 
				var results= []; console.log(array);
				forEach(deps, function(mid){
